...
def test_password_hashing():
    ...
    user = User.objects.create_user(username='hasheduser', email='c@c.com', password=raw_password)
...
def test_unique_email_constraint():
    ...
    with pytest.raises(Exception):
        User.objects.create_user(username='user2', email='duplicate@test.com', password='test')
...
def test_create_superuser():
    superuser = User.objects.create_superuser(username='admin', email='admin@admin.com', password='adminpassword', full_name='Super Admin')
